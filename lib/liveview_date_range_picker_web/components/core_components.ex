defmodule LiveviewDateRangePickerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewDateRangePickerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewDateRangePickerWeb.Gettext, "errors", msg, opts)
    end
  end
